...
Route::controller(TransformerController::class)->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::middleware('role:ad')->group(function () {
            Route::get('/ExportOperationsReport', 'transform')->name('report.ExportOperationsReport');
            Route::get('/FileReports', )->name('report.FileReports');
        });
        
        Route::middleware('role:User')->group(function () {
            Route::get('/UserFileReports',  'transform')->name('report.UserFileReports');
        });
