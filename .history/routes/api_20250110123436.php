...
Route::controller(TransformerController::class)->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::middleware('role:admin')->group(function () {
            Route::get('/ExportFileOperationsReport/{groupId}', 'transform')->name('report.ExportFileOperationsReport');
            Route::get('/ExportUserOperationsReport/{groupId}', 'ReportController@ExportUserOperationsReport')->name('report.ExportUserOperationsReport');
        });
        
        Route::middleware('role:user')->group(function () {
            Route::get('/ExportFileOperationsReport/{groupId}', 'ReportController@ExportFileOperationsReport')->name('report.ExportFileOperationsReport');
        });
