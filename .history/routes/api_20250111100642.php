...
Route::controller(TransformerController::class)->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::get('/reports/file-operations/csv/{groupId}', 'transform')->name('report.exportFileOperationsReport');

        Route::middleware('role:admin')->group(function () {
            Route::get('reports/user-operations/{groupId}', 'transform')->name('report.exportFileOperationsReportAsCSV');

        });
        http://localhost:8000/api/reports/file-operations/csv/1
