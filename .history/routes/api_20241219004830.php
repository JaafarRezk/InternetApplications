...
Route::middleware('auth:sanctum')->group(function () {
    Route::post('/send-invitation/{groupId}/{invitedUserId}', [NotificationController::class, 'sendGroupInvitation']);
    Route::post('/respond-invitation', [NotificationController::class, 'respondToInvitation']);
});
