...
Route::controller(TransformerController::class)->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::post('/send-invitation/{groupId}/{invitedUserId}', 'transform')->name('group.sendGroupInvitation');
...
Route::middleware('auth:sanctum')->group(function () {
    Route::get('/send-invitation/{groupId}/{invitedUserId}', [NotificationController::class, 'sendGroupInvitation']);
});
