...
class FileFacade extends Facade
{
    const aspects_map = array(
       ...
       'downloadFile' =>array('TransactionAspect', 'LoggingAspect','FileLoggingAspect'),
    );
...
{
    $id = $this->message['urlParameters']['id']; // نحصل على المعرف من الرسالة
    $response = $this->fileService->downloadFile($id); // استدعاء الخدمة لتحميل الملف
