    ...
    public function addFilesToGroup($bodyParameters)
{
    ...
    public function sendGroupInvitation($groupId, $invitedUserId)
    {
        ...
        // بث الإشعار للمستخدم المدعو عبر القناة الخاصة به
        broadcast(new UserNotificationEvent($message, $invitedUserId))->toOthers(); // `toOthers` لعدم إرسال الإشعار لنفس المستخدم إذا كان مستمعًا للقناة
